...
if (!isset($_SESSION['kh_tendangnhap_logged']) || empty($_SESSION['kh_tendangnhap_logged'])) {
    echo 'Vui lòng Đăng nhập trước khi Thanh toán! <a href="/back_end/backend/auth/login.php">Click vào đây để đến trang Đăng nhập</a>';
    die;
} else {
...
EOT;
    ...
    echo 'Đặt hàng thành công. <a href="/back_end/frontend/">Bấm vào đây để quay về trang chủ</a>';
}
